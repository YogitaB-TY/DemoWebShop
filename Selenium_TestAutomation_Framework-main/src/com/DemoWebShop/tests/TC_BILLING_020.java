...
public class TC_BILLING_020 extends BaseTest {
	...
	public void TC020(String email,String pwd,String search,String giftCardCode) throws InterruptedException {
		...
		sc.enter_Giftcard(giftCardCode);
		sc.apply_giftcard();
	}
